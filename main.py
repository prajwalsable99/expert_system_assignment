...
def preprocess():
    ...
    for disease in diseases_list:
        disease_s_file = open(f"Disease symptoms\\{disease}.txt" )
        ...
        disease_s_file = open(f"Disease descriptions\\{disease}.txt")
        disease_s_data = disease_s_file.read()
        d_desc_map[disease] = disease_s_data
        disease_s_file.close()

        disease_s_file = open(f"Disease treatments\\{disease}.txt")
        disease_s_data = disease_s_file.read()
